...
################################################################################
#World Nank data with added top-level domains
...
################################################################################
#Fig 7. -- Multilingual publishing among journals using OJS
...
ggsave("./vis/OJSmultilingual_bar.png", dpi = 300, width = 10, height = 6)

################################################################################
#Fig 8. -- Multilingual diagram of journals using OJS
...
upset(fromExpression(expressionInput), 
      ...
      point.size = 3,
      text.scale = c(2.4, 1.4, 1.2, 1.2, 1.6, 1.4))
