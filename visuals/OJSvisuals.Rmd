---
title: "Visuals for 'How Many Journals Are There? Counting the Discounted'"
author: "Jon Ball"
date: "10/4/2022"
output: 
  html_document:
...
## Journals by United Nations regional group (*n* = 25,651) {#fig3}
...
## The distribution of journals using OJS in World Bank income groups, which are based on gross national income (GNI) per capita (*n* = 25,651) {#fig2}
...
## The distribution of active journals using OJS in top 10 countries (*n* = 19,110; % total *n* = 25,651) {#fig1}
...
## Top ten primary languages of publication for active journals using OJS (*n* = 22,561) {#fig4}
...
## Number of languages employed by journals using OJS (*n* = 22,382) {#fig5}
...
## Distribution of top four languages across mono- and multilingual journals (N = 22,561)
...
## The disciplines of journals using OJS to publish in top 10 primary languages (*n* = 22,504) {#fig6}
...
## The distribution of journals using OJS to publish in top-ten primary languages by their disciplinary coverage (*n* = 22,504) {#fig7}
